...
var _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.checkCMSSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (signature, unencryptedMessage, detached) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function checkXMLSignature() {
                var cadesSignedData;
                try {
...
Object.defineProperty(exports, "__esModule", { value: true });
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.CheckExtensionLoaded = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [2 /*return*/, window.cadesplugin_extension_loaded];
            case 3:
                error_1 = _a.sent();
                console.error(error_1);
...
var _afterPluginsLoaded_1 = __webpack_require__(/*! ../helpers/_afterPluginsLoaded */ "./helpers/_afterPluginsLoaded.ts");
var _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
exports.CheckPluginLoaded = _afterPluginsLoaded_1._afterPluginsLoaded(function () {
    return eval(_generateCadesFn_1._generateCadesFn(function () {
        ...
        try {
            ...
            var pluginVersion = _generateCadesFn_1.__cadesAsyncToken__ + cadesAbout.PluginVersion;
            var majorVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.MajorVersion;
            var minorVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.MinorVersion;
            var buildVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.BuildVersion;
...
var _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.CheckProviderLoaded = _afterPluginsLoaded_1._afterPluginsLoaded(function () {
    return eval(_generateCadesFn_1._generateCadesFn(function getSystemInfo() {
        var cadesAbout;
        try {
            cadesAbout = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.About');
            var providerVersion = _generateCadesFn_1.__cadesAsyncToken__ + cadesAbout.CSPVersion('', 80);
            var majorVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.MajorVersion;
            var minorVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.MinorVersion;
            var buildVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.BuildVersion;
            return majorVersion + "." + minorVersion + "." + buildVersion;
        }
        catch (error) {
            console.error(error);
...
var _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
var _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.checkXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (signature) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function checkXMLSignature() {
                var cadesSignedXML;
                try {
...
var _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
var _getCadesCert_1 = __webpack_require__(/*! ../helpers/_getCadesCert */ "./helpers/_getCadesCert.ts");
var _reverseString_1 = __webpack_require__(/*! ../helpers/_reverseString */ "./helpers/_reverseString.ts");
var _convertHexToBase64_1 = __webpack_require__(/*! ../helpers/_convertHexToBase64 */ "./helpers/_convertHexToBase64.ts");
exports.createRawSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, signedInfo) { return __awaiter(void 0, void 0, void 0, function () {
    var cadesplugin, cadesCertificate;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                templateXml = new XMLSerializer().serializeToString(parsedXml).replace(/&lt;/g, '<').replace(/&gt;/g, '>');
                return [2 /*return*/, eval(_generateCadesFn_1._generateCadesFn(function createXMLSignature() {
                        var cadesSigner;
                        var cadesSignedXML;
                        try {
 ...
 * @returns подпись
 */
exports.createXadesSignature = _afterPluginsLoaded_1._afterPluginsLoaded(function (thumbprint, unencryptedMessage) { return __awaiter(void 0, void 0, void 0, function () {
    var cadesplugin, cadesCertificate;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._convertHexToBase64 = function (hex) {
    return btoa(hex
        .match(/\w{2}/g)
        .map(function (a) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._reverseStr = function (str) {
    var newStr = '';
    for (var i = str.length - 1; i >= 1; i -= 2) {
