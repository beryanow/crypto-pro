...
const _convertHexToBin_1 = __webpack_require__(/*! ../helpers/_convertHexToBin */ "./helpers/_convertHexToBin.ts");
const _convertBinToBase64_1 = __webpack_require__(/*! ../helpers/_convertBinToBase64 */ "./helpers/_convertBinToBase64.ts");
...
exports.createRawSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, signedInfo) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function createAttachedSignature() {
        ...
        console.log(_reverseString_1._reverseStr(sRawSignature));
        console.log(_convertHexToBin_1._convertHexToBin(sRawSignature));
        console.log(_reverseString_1._reverseStr(_convertHexToBin_1._convertHexToBin(sRawSignature)));
        console.log(_convertBinToBase64_1._convertBinToBase64(_convertHexToBin_1._convertHexToBin(sRawSignature)));
        console.log(_convertHexToBase64_1._convertHexToBase64(sRawSignature));
        console.log(_convertHexToBase64_1._convertHexToBase64(_reverseString_1._reverseStr(sRawSignature)));
...
/***/ "./helpers/_convertBinToBase64.ts":
/*!****************************************!*\
  !*** ./helpers/_convertBinToBase64.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._convertBinToBase64 = (binData) => {
