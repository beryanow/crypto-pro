...
/******/ 	return __webpack_require__(__webpack_require__.s = "./crypto-pro-enhanced.ts");
/******/ })
/************************************************************************/
/******/ ({
...
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.checkCMSSignature = _afterPluginsLoaded_1._afterPluginsLoaded((signature, unencryptedMessage, detached) => __awaiter(void 0, void 0, void 0, function* () {
    return eval(_generateCadesFn_1._generateCadesFn(function checkXMLSignature() {
        let cadesSignedData;
        try {
        ...
        try {
            _generateCadesFn_1.__cadesAsyncToken__ + cadesSignedData.VerifyCades(signature, cadesplugin.CADESCOM_CADES_BES, detached);
        }
        catch (error) {
            console.error(error);
...
Object.defineProperty(exports, "__esModule", { value: true });
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.CheckExtensionLoaded = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const _afterPluginsLoaded_1 = __webpack_require__(/*! ../helpers/_afterPluginsLoaded */ "./helpers/_afterPluginsLoaded.ts");
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
exports.CheckPluginLoaded = _afterPluginsLoaded_1._afterPluginsLoaded(() => {
    return eval(_generateCadesFn_1._generateCadesFn(() => {
        let cadesAbout;
        try {
            cadesAbout = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.About');
            const pluginVersion = _generateCadesFn_1.__cadesAsyncToken__ + cadesAbout.PluginVersion;
            const majorVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.MajorVersion;
            const minorVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.MinorVersion;
            const buildVersion = _generateCadesFn_1.__cadesAsyncToken__ + pluginVersion.BuildVersion;
...
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.CheckProviderLoaded = _afterPluginsLoaded_1._afterPluginsLoaded(() => {
    return eval(_generateCadesFn_1._generateCadesFn(function getSystemInfo() {
        let cadesAbout;
        try {
            cadesAbout = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.About');
            const providerVersion = _generateCadesFn_1.__cadesAsyncToken__ + cadesAbout.CSPVersion('', 80);
            const majorVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.MajorVersion;
            const minorVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.MinorVersion;
            const buildVersion = _generateCadesFn_1.__cadesAsyncToken__ + providerVersion.BuildVersion;
            return `${majorVersion}.${minorVersion}.${buildVersion}`;
        }
        catch (error) {
            console.error(error);
...
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
exports.checkXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded((signature) => __awaiter(void 0, void 0, void 0, function* () {
    return eval(_generateCadesFn_1._generateCadesFn(function checkXMLSignature() {
        let cadesSignedXML;
        try {
...
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const getCertificate_1 = __webpack_require__(/*! ./getCertificate */ "./api/getCertificate.ts");
exports.createCMSSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, detached) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const certificate = yield getCertificate_1.getCertificate(thumbprint);
    const cadesCertificate = certificate._cadesCertificate;
    const algorithm = yield certificate.getAlgorithm();
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function createAttachedSignature() {
        ...
        try {
            signature =
                _generateCadesFn_1.__cadesAsyncToken__ + cadesSignedData.SignCades(cadesSigner, cadesplugin.CADESCOM_CADES_BES, detached);
        }
        catch (error) {
            console.error(error);
 ...
 * @returns подпись в формате PKCS#7
 */
exports.createPKCS7Signature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, detached) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function createAttachedSignature() {
        let cadesSigner;
...
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const _getCadesCert_1 = __webpack_require__(/*! ../helpers/_getCadesCert */ "./helpers/_getCadesCert.ts");
const _reverseString_1 = __webpack_require__(/*! ../helpers/_reverseString */ "./helpers/_reverseString.ts");
const _convertHexToBase64_1 = __webpack_require__(/*! ../helpers/_convertHexToBase64 */ "./helpers/_convertHexToBase64.ts");
exports.createRawSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, signedInfo) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function createAttachedSignature() {
        let oRawSignature;
        let hashedData;
        try {
            oRawSignature = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.RawSignature');
            hashedData = _generateCadesFn_1.__cadesAsyncToken__ + _generateCadesFn_1.__createCadesPluginObject__('CAdESCOM.HashedData');
        }
        catch (error) {
            console.error(error);
            throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при инициализации хеширования');
        }
        try {
            void (_generateCadesFn_1.__cadesAsyncToken__ +
                hashedData.propset_Algorithm(cadesplugin.CADESCOM_HASH_ALGORITHM_CP_GOST_3411_2012_256));
            void (_generateCadesFn_1.__cadesAsyncToken__ + hashedData.propset_DataEncoding(cadesplugin.CADESCOM_BASE64_TO_BINARY));
            void (_generateCadesFn_1.__cadesAsyncToken__ + hashedData.Hash(signedInfo));
        }
        catch (error) {
            console.error(error);
            throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при указании данных для хеширования');
        }
        let sRawSignature;
        try {
            sRawSignature = _generateCadesFn_1.__cadesAsyncToken__ + oRawSignature.SignHash(hashedData, cadesCertificate);
        }
        catch (error) {
            console.error(error);
            throw new Error(_extractMeaningfulErrorMessage_1._extractMeaningfulErrorMessage(error) || 'Ошибка при подписании данных');
        }
        return _convertHexToBase64_1._convertHexToBase64(_reverseString_1._reverseStr(sRawSignature));
    }));
}));
 ...
 * @returns подпись
 */
exports.createXMLDSigSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    ...
    return eval(_generateCadesFn_1._generateCadesFn(function createXMLSignature() {
        ...
        return btoa(encodeURIComponent(signature).replace(/%([0-9A-F]{2})/g, (_, p1) => String.fromCharCode(parseInt('0x' + p1, 16))));
    }));
}));
 ...
 * @returns подпись
 */
exports.createXMLDSigTemplateSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function createXMLSignature() {
        let cadesSigner;
...
const _extractMeaningfulErrorMessage_1 = __webpack_require__(/*! ../helpers/_extractMeaningfulErrorMessage */ "./helpers/_extractMeaningfulErrorMessage.ts");
const _generateCadesFn_1 = __webpack_require__(/*! ../helpers/_generateCadesFn */ "./helpers/_generateCadesFn.ts");
const _generateUUID_1 = __webpack_require__(/*! ../helpers/_generateUUID */ "./helpers/_generateUUID.ts");
const _encodeBase64Representation_1 = __webpack_require__(/*! ../helpers/_encodeBase64Representation */ "./helpers/_encodeBase64Representation.ts");
const _decodeBase64Representation_1 = __webpack_require__(/*! ../helpers/_decodeBase64Representation */ "./helpers/_decodeBase64Representation.ts");
const getCertificate_1 = __webpack_require__(/*! ./getCertificate */ "./api/getCertificate.ts");
const createSignatureTemplate = (contentBase64) => `<?xml version="1.0" encoding="UTF-8"?>
<Content>
    ${contentBase64}
...
exports.createXMLSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, advanced, xml) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const certificate = yield getCertificate_1.getCertificate(thumbprint);
    const cadesCertificate = certificate._cadesCertificate;
...
exports.createXPathTransformSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, xPathSchemaMessage, advanced) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    unencryptedMessage = decodeURIComponent(atob(unencryptedMessage)
        .split('')
 ...
 * @returns подпись
 */
exports.createXadesSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    unencryptedMessage = decodeURIComponent(atob(unencryptedMessage)
        .split('')
 ...
 * @returns подпись
 */
exports.createXadesTemplateSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    return eval(_generateCadesFn_1._generateCadesFn(function createXMLSignature() {
        let cadesSigner;
 ...
 * @returns подпись
 */
exports.createXadesXPathFilter2Signature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, xsltSchemaMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    const sContent = `
<a>
 ...
 * @returns подпись
 */
exports.createXadesXsltSignature = _afterPluginsLoaded_1._afterPluginsLoaded((thumbprint, unencryptedMessage, xsltSchemaMessage) => __awaiter(void 0, void 0, void 0, function* () {
    const { cadesplugin } = window;
    const cadesCertificate = yield _getCadesCert_1._getCadesCert(thumbprint);
    const sContent = `
<a>
...
__export(__webpack_require__(/*! ./createRawSignature */ "./api/createRawSignature.ts"));
__export(__webpack_require__(/*! ./createHash */ "./api/createHash.ts"));
__export(__webpack_require__(/*! ./checkExtensionLoaded */ "./api/checkExtensionLoaded.ts"));
__export(__webpack_require__(/*! ./checkPluginLoaded */ "./api/checkPluginLoaded.ts"));
__export(__webpack_require__(/*! ./checkProviderLoaded */ "./api/checkProviderLoaded.ts"));
__export(__webpack_require__(/*! ./checkXMLSignature */ "./api/checkXMLSignature.ts"));
__export(__webpack_require__(/*! ./checkCMSSignature */ "./api/checkCMSSignature.ts"));
...
exports.CADESCOM_XADES_BES = 0x00000020;
...
/***/ "./helpers/_convertHexToBase64.ts":
/*!****************************************!*\
  !*** ./helpers/_convertHexToBase64.ts ***!
  \****************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._convertHexToBase64 = (hex) => {
    return btoa(hex
        .match(/\w{2}/g)
        .map(function (a) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._decodeBase64Representation = (signature) => decodeURIComponent(atob(signature)
    .split('')
    .map((c) => '%' + ('00' + c.charCodeAt(0).toString(16)).slice(-2))
    .join(''));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports._encodeBase64Representation = (signature) => btoa(encodeURIComponent(signature).replace(/%([0-9A-F]{2})/g, (_, p1) => String.fromCharCode(parseInt('0x' + p1, 16))));
...
//# sourceMappingURL=crypto-pro-enhanced.js.map